       ...
       <div class="col-xl-6">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">站点程序信息</h3>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush"><thead class="thead-light"><tr><th scope="col">云凌支付系统哇</th><th scope="col">信息详情</th></tr></thead><tbody></tbody>
              </table>
            </div>
          </div>
        </div>
