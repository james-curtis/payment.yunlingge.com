<?php
//用户唯一key
define('WEBSCAN_U_KEY', '57b647255b6d0945f77b86e2d1a99819');
//数据回调统计地址
...
$webscan_white_directory='admin|ht';
...
$webscan_white_url = array('ulist.php' => 'my=add', 'ulist.php' => 'my=edit', 'ulist.php' => 'my=add_submit', 'ulist.php' => 'my=edit_submit', 'ulist.php' => 'my=delete', 'plist.php' => 'my=add', 'plist.php' => 'my=edit', 'plist.php' => 'my=add_submit', 'plist.php' => 'my=edit_submit', 'plist.php' => 'my=delete');
?>