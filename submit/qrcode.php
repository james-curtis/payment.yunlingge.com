...
$trade_no=date("YmdHis").mt_rand(11111,99999);
...
$input->SetNotify_url('http://'.$_SERVER['HTTP_HOST'].'/wxpay_notify.php');
...
$params["body"] = $name;
$params["fee_type"] = "CNY";
$params["notify_url"] = 'http://'.$_SERVER['HTTP_HOST'].'/qqpay_notify.php';
