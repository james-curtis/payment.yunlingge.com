...
$data = get_curl('http://www.kidsworld.me/api.php?act=orders&limit=50&pid=1622&key=Q9Tex5fDTF6EUJgFvX9QGEUtf6ErU6qu');
...
if($arr['code']==1){
  ...
  processOrder($srow);
				echo '云凌支付程序非常负责的告诉您，已成功补单的有：'.$out_trade_no.'<br/>';
			}
		}
	}
	exit('ok');
